...
const recoverAccount = async (
  ...
  const wallethandle = (
    await kmdclient.initWalletHandle(walletid, new_wallet_pw)
  ).wallet_handle_token;
...
(async () => {
  ...
  const walletMnemonic =
    'laundry cute artist patient team spatial frozen warrior act later wool indoor vibrant boost merit rifle someone cushion owner mammal artwork copy evidence above tonight';
